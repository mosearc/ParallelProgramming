...
int main(int argc, char** argv) {
    ...
    double start_time_opt, end_time_opt, total_time_opt;
    double start_time_opt2, end_time_opt2, total_time_opt2;
